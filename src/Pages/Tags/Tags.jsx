...
export default function Tags(){
    const tagsList =[
        ...
        },
        {
            id:4,
            tagName:'java',
            tagDesc:'Java is a high-level object oriented programming language. Use this tag when you are having problems using or understanding the language itself.'
        },
        {
            id:5,
            tagName:'php',
        ...
        },
        {
            id:7,
            tagName:'android',
            tagDesc:'Android is Googles mobile operating system, used for programming or developing digital devices (Smartphones, Tablets, Automobiles, TVs, Wear, Glass, IoT).'
        },
        {
            id:8,
            tagName:'css',
        ...
        <div className="home-container-1">
            ...
            <div className="home-container-2">
                 ...
                 <div className="tags-list-container">
                    {
                        tagsList.map((tag) => (
                            <TagsList tag={tag} key={tagsList._id}/>
                        ))
                    }
                 </div>
            </div>
